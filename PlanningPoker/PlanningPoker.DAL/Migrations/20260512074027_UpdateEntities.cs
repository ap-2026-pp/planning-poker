        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomValues = table.Column<string>(type: "text", nullable: true),
                    InviteCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    RevealPolicy = table.Column<int>(type: "integer", nullable: false),
                    IssuesPolicy = table.Column<int>(type: "integer", nullable: false),
                    AutoRevealCards = table.Column<bool>(type: "boolean", nullable: false),
                    EnableFunFeature = table.Column<bool>(type: "boolean", nullable: false),
                    DefaultTimerMinutes = table.Column<int>(type: "integer", nullable: false),
                    AutoResetTimer = table.Column<bool>(type: "boolean", nullable: false),
                    ShowAverage = table.Column<bool>(type: "boolean", nullable: false),
                    ShowCountdownAnimation = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanRevealCards = table.Column<bool>(type: "boolean", nullable: false),
                    CanManageIssues = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estimate = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Agreement = table.Column<double>(type: "double precision", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
